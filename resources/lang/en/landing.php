...
return [
    ...
    'benefits' => [
        ...
        'trial' => [
            ...
            'pricing' => [
                ...
                'offer' => '🎉 Get 1 month FREE when you sign up!',
            ],
    ...
    // Footer
    'footer' => [
        'description' => 'Streamline your tenant application process from first contact to move-in. Say goodbye to incomplete applications, missing documents, and communication chaos.',
        'product' => 'Product',
        'support' => 'Support',
