...
export function useWizardSteps(): WizardStepConfig<WizardStep>[] {
    ...
    return useMemo(
        () => [
            {
                id: 'property-type',
                title: t('wizard.property.steps.propertyType.title'),
                shortTitle: t('wizard.property.steps.propertyType.shortTitle'),
                description: t('wizard.property.steps.propertyType.description'),
                fields: ['type', 'subtype'],
            },
            {
                id: 'location',
                title: t('wizard.property.steps.location.title'),
                shortTitle: t('wizard.property.steps.location.shortTitle'),
                description: t('wizard.property.steps.location.description'),
                fields: ['house_number', 'street_name', 'street_line2', 'city', 'state', 'postal_code', 'country'],
            },
            {
                id: 'specifications',
                title: t('wizard.property.steps.specifications.title'),
                shortTitle: t('wizard.property.steps.specifications.shortTitle'),
                description: t('wizard.property.steps.specifications.description'),
                fields: [
                    'bedrooms',
                    'bathrooms',
                    'size',
            ...
            {
                id: 'amenities',
                title: t('wizard.property.steps.amenities.title'),
                shortTitle: t('wizard.property.steps.amenities.shortTitle'),
                description: t('wizard.property.steps.amenities.description'),
                fields: [
                    'kitchen_equipped',
                    'kitchen_separated',
                    'has_cellar',
            ...
            {
                id: 'energy',
                title: t('wizard.property.steps.energy.title'),
                shortTitle: t('wizard.property.steps.energy.shortTitle'),
                description: t('wizard.property.steps.energy.description'),
                optional: true,
                fields: ['energy_class', 'thermal_insulation_class', 'heating_type'],
            },
            {
                id: 'pricing',
                title: t('wizard.property.steps.pricing.title'),
                shortTitle: t('wizard.property.steps.pricing.shortTitle'),
                description: t('wizard.property.steps.pricing.description'),
                fields: ['rent_amount', 'rent_currency', 'available_date'],
            },
            {
                id: 'media',
                title: t('wizard.property.steps.media.title'),
                shortTitle: t('wizard.property.steps.media.shortTitle'),
                description: t('wizard.property.steps.media.description'),
                fields: ['title', 'description'],
            },
            {
                id: 'review',
                title: t('wizard.property.steps.review.title'),
                shortTitle: t('wizard.property.steps.review.shortTitle'),
                description: t('wizard.property.steps.review.description'),
                fields: [],
            },
        ],
        [t],
