...
function Toggle(***REMOVED***
  ...
  size,
  ...props
***REMOVED***: React.ComponentProps<typeof TogglePrimitive.Root> &
  VariantProps<typeof toggleVariants>) ***REMOVED***
  return (
    <TogglePrimitive.Root
      data-slot="toggle"
      className=***REMOVED***cn(toggleVariants(***REMOVED*** variant, size, className ***REMOVED***))***REMOVED***
      ***REMOVED***...props***REMOVED***
    />
  )
***REMOVED***

export ***REMOVED*** Toggle, toggleVariants ***REMOVED***
