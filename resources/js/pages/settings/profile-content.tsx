    ...
    return (
        <div className="space-y-6">
                        ...
                        <>
                            ...
                            {mustVerifyEmail && auth.user.email_verified_at === null && (
                                <div className="border-warning/20 bg-warning/10 rounded-lg border p-4">
                                    <p className="text-warning text-sm">
                                        ...
                                        <Link href={send()} as="button" className="font-medium underline hover:no-underline">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <Transition
                                    ...
                                    leaveTo="opacity-0"
                                >
                                    <p className="text-success text-sm font-medium">{t(translations.settings, 'account.saved_successfully')}</p>
                                </Transition>
                            </div>
                        </>
                    )}
            ...
            <div className="xs:rounded-2xl xs:border xs:border-destructive/20 xs:bg-card xs:p-6 xs:shadow-sm">
                ...
                <p className="mb-6 text-sm text-muted-foreground">{t(translations.settings, 'account.delete_account_description')}</p>

                <button className="cursor-pointer rounded-xl border border-destructive bg-destructive/10 px-6 py-3 font-medium text-destructive transition-all hover:bg-destructive/20">
