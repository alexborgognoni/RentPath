            ...
            <div className="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
                <header className="mb-6 w-full max-w-[335px] text-sm not-has-[nav]:hidden lg:max-w-4xl">
                    <nav className="flex items-center justify-end gap-4">
                        ***REMOVED***auth.user ? (
                            <Link
                                href=***REMOVED***route('dashboard')***REMOVED***
                            ...
                            <>
                                <Link
                                    href=***REMOVED***route('login')***REMOVED***
                                    className="inline-block rounded-sm border border-transparent px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#19140035] dark:text-[#EDEDEC] dark:hover:border-[#3E3E3A]"
                                >
                                    Log in
                                </Link>
                                <Link
                                    href=***REMOVED***route('register')***REMOVED***
                                    className="inline-block rounded-sm border border-[#19140035] px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#1915014a] dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b]"
                                >
                                    Register
                                </Link>
                    ...
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                                ...
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]">
                                    ...
                                    <span>
                                        ...
                                        >
                                            ...
                                            <svg
                                                width=***REMOVED***10***REMOVED***
                                                height=***REMOVED***11***REMOVED***
                                                viewBox="0 0 10 11"
                                                fill="none"
                        ...
                        <div className="relative -mb-px aspect-[335/376] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]">
                            ...
                            >
                                ...
                                <g
                                    style=***REMOVED******REMOVED*** mixBlendMode: 'hard-light' ***REMOVED******REMOVED***
                                ...
                                <g
                                ***REMOVED*** @ts-expect-error 'plus-darker' doesn't seem to be defined in the 'csstype' module */
                                    style=***REMOVED******REMOVED*** mixBlendMode: 'plus-darker' ***REMOVED******REMOVED***
                                    className="translate-y-0 opacity-100 transition-all delay-300 duration-750 starting:translate-y-4 starting:opacity-0"
                                >
                                    <path
