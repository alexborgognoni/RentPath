...
test('final submission requires all steps valid', function () {
    ...
    $response = $this->actingAs($this->tenant)
        ->post("/properties/{$this->property->id}/apply", [
            ...
            'current_address_street_name' => 'Main Street',
            'current_address_house_number' => '123',
            'current_address_city' => 'Amsterdam',
            'current_address_postal_code' => '1012AB',
            'current_address_country' => 'NL',
            'current_address_move_in_date' => now()->subYears(2)->format('Y-m-d'),
            'current_monthly_rent' => 1000,
            'current_rent_currency' => 'eur',
            'reason_for_moving' => 'relocation_work',
            // Step 7: Consent
